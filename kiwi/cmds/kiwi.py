...
from kiwi.cmds.configure import configure_cmd
from kiwi.cmds.farm import farm_cmd
from kiwi.cmds.init import init_cmd
from kiwi.cmds.keys import keys_cmd
from kiwi.cmds.netspace import netspace_cmd
from kiwi.cmds.plots import plots_cmd
from kiwi.cmds.show import show_cmd
from kiwi.cmds.start import start_cmd
from kiwi.cmds.stop import stop_cmd
from kiwi.cmds.wallet import wallet_cmd
from kiwi.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage kiwi blockchain infrastructure ({__version__})\n",
...
def run_daemon_cmd(ctx: click.Context) -> None:
    from kiwi.daemon.server import async_run_daemon
    import asyncio
