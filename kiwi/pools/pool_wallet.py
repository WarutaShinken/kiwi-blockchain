...
from kiwi.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from kiwi.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from kiwi.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from kiwi.pools.pool_puzzles import (
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `kiwi singleton` that is
