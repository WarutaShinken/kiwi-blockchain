...
from kiwi.harvester.harvester import Harvester
from kiwi.plotting.plot_tools import PlotInfo, parse_plot_info
from kiwi.protocols import harvester_protocol
from kiwi.protocols.farmer_protocol import FarmingInfo
from kiwi.protocols.harvester_protocol import Plot
from kiwi.protocols.protocol_message_types import ProtocolMessageTypes
from kiwi.server.outbound_message import make_msg
...
from kiwi.util.ints import uint8, uint32, uint64
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSKiwiConnection
    ):
        """
