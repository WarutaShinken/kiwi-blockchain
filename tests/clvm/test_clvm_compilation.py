...
wallet_program_files = set(
    [
        "kiwi/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "kiwi/wallet/puzzles/cc.clvm",
        "kiwi/wallet/puzzles/chialisp_deserialisation.clvm",
        "kiwi/wallet/puzzles/rom_bootstrap_generator.clvm",
        "kiwi/wallet/puzzles/generator_for_single_coin.clvm",
        "kiwi/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "kiwi/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "kiwi/wallet/puzzles/lock.inner.puzzle.clvm",
        "kiwi/wallet/puzzles/p2_conditions.clvm",
        "kiwi/wallet/puzzles/p2_delegated_conditions.clvm",
        "kiwi/wallet/puzzles/p2_delegated_puzzle.clvm",
        "kiwi/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "kiwi/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "kiwi/wallet/puzzles/p2_puzzle_hash.clvm",
        "kiwi/wallet/puzzles/rl_aggregation.clvm",
        "kiwi/wallet/puzzles/rl.clvm",
        "kiwi/wallet/puzzles/sha256tree_module.clvm",
        "kiwi/wallet/puzzles/singleton_top_layer.clvm",
        "kiwi/wallet/puzzles/did_innerpuz.clvm",
        "kiwi/wallet/puzzles/decompress_puzzle.clvm",
        "kiwi/wallet/puzzles/decompress_coin_spend_entry_with_prefix.clvm",
        "kiwi/wallet/puzzles/decompress_coin_spend_entry.clvm",
        "kiwi/wallet/puzzles/block_program_zero.clvm",
        "kiwi/wallet/puzzles/test_generator_deserialize.clvm",
        "kiwi/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "kiwi/wallet/puzzles/p2_singleton.clvm",
        "kiwi/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "kiwi/wallet/puzzles/pool_member_innerpuz.clvm",
        "kiwi/wallet/puzzles/singleton_launcher.clvm",
        "kiwi/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["kiwi/wallet/puzzles/create-lock-puzzlehash.clvm", "kiwi/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "kiwi/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to kiwi/wallet/puzzles, but not added to `wallet_program_files`
        """
