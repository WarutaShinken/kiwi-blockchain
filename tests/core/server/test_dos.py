...
from kiwi.protocols.shared_protocol import Handshake
from kiwi.server.outbound_message import make_msg, Message
from kiwi.server.rate_limits import RateLimiter
from kiwi.server.server import ssl_context_for_client
from kiwi.server.ws_connection import WSKiwiConnection
from kiwi.types.peer_info import PeerInfo
from kiwi.util.ints import uint16, uint64
...
class TestDos:
    ...
    async def test_large_message_disconnect_and_ban(self, setup_two_nodes):
        ...
        ssl_context = ssl_context_for_client(
            server_2.kiwi_ca_crt_path, server_2.kiwi_ca_key_path, server_2.p2p_crt_path, server_2.p2p_key_path
        )
    ...
    async def test_spam_tx(self, setup_two_nodes):
        ...
        ws_con: WSKiwiConnection = list(server_1.all_connections.values())[0]
        ws_con_2: WSKiwiConnection = list(server_2.all_connections.values())[0]
