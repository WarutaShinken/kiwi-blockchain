...
testnet_kwargs = {
    ...
    "NUMBER_ZERO_BITS_PLOT_FILTER": 1,  # 9,  # H(plot signature of the challenge) must start with these many zeroes
    ...
    "GENESIS_CHALLENGE": bytes.fromhex("70ce44cade80983b805fa21caf3629047cec9e9fef973e4f332c9e41eb47b794"),
    # Forks of kiwi should change this value to provide replay attack protection. This is set to mainnet genesis chall
    "AGG_SIG_ME_ADDITIONAL_DATA": bytes.fromhex("b5f3ef35e1b47979d718dfe632d3bf309c6d376fadcb2028dfb42d849caed3e4"),
    ...
    "INITIAL_FREEZE_END_TIMESTAMP": 0,  # 1620061200,  # Mon May 03 2021 17:00:00 GMT+0000
    "NETWORK_TYPE": 0,
