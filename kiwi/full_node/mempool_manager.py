...
from kiwi.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from kiwi.util.clvm import int_from_bytes
from kiwi.util.condition_tools import (
    pkm_pairs_for_conditions_dict,
    coin_announcements_names_for_npc,
    puzzle_announcements_names_for_npc,
)
from kiwi.util.errors import Err
from kiwi.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 XKW per block, or about 0.00005 XKW for two
        # spends.
