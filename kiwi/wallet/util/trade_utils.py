...
from kiwi.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "kiwi" in cc_discrepancies:
                    cc_discrepancies["kiwi"] = cc_discrepancies["kiwi"] + diff
                else:
                    cc_discrepancies["kiwi"] = diff
