...
from kiwi.util.ints import uint32, uint16
...
async def main() -> None:
    ...
    try:
        ...
        address1 = "xkw1fjp4kw8gyqypra9s7fkqz9ncjsr5qpa2q8rnp9e88dwvhfkpe2lqerwstu"  # Key 1
        address2 = "xkw1f7xpksxdslqzt2mymy83g7evzpnkxv9llrmna95sjcjp2ktf5enqmm3eyk"  # Key 2
