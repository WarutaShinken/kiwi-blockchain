...
from kiwi.consensus.network_type import NetworkType
from kiwi.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from kiwi.farmer.farmer import Farmer
from kiwi.protocols import farmer_protocol, harvester_protocol
from kiwi.protocols.harvester_protocol import PoolDifficulty
...
from kiwi.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSKiwiConnection
    ):
        """
