...
from kiwi.wallet.puzzles.puzzle_utils import (
...
from kiwi.wallet.secret_key_store import SecretKeyStore
from kiwi.wallet.sign_coin_spends import sign_coin_spends
...
class Wallet:
    ...
    async def create_spend_bundle_relative_kiwi(self, kiwi_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if kiwi_amount < 0:
            utxos = await self.select_coins(abs(kiwi_amount), exclude)
        else:
        ...
        kiwi_amount = spend_value + kiwi_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": kiwi_amount}]
