...
from kiwi.plotting.plot_tools import stream_plot_info_ph, stream_plot_info_pk
from kiwi.protocols import farmer_protocol
from kiwi.rpc.farmer_rpc_api import FarmerRpcApi
from kiwi.rpc.farmer_rpc_client import FarmerRpcClient
from kiwi.rpc.harvester_rpc_api import HarvesterRpcApi
from kiwi.rpc.harvester_rpc_client import HarvesterRpcClient
...
from kiwi.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xkw"), encode_puzzle_hash(new_ph_2, "xkw"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xkw"))
            ...
            assert config["farmer"]["xkw_target_address"] == encode_puzzle_hash(new_ph, "xkw")
            assert config["pool"]["xkw_target_address"] == encode_puzzle_hash(new_ph_3, "xkw")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xkw")
