...
from kiwi.pools.pool_config import PoolWalletConfig
from kiwi.util.config import load_config, save_config, create_default_kiwi_config
...
def test_pool_config():
    ...
    create_default_kiwi_config(test_root, ["config.yaml"])
